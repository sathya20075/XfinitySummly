...
public class SummlyMain
{
	...
	public static void main(String args[]){
		...
		content += "Coming off record earnings, American Airlines says it will make profit-sharing payments to employees.\n";
		content += "Some American employees had complained that they did not participate in profit sharing, unlike their counterparts at other airlines.\n";
		content += "For instance, Delta shared $1.5 billion last year, and United paid out $698 million.\n";
		content += "On Wednesday, American said it would share 5 percent of its pretax 2016 earnings with all employees, except top management, in early 2017.\n"; 
		content += "Including its regional-flying subsidiaries, American has about 118,000 employees.\n";
